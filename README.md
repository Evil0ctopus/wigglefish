...
`wigglefish scan` without `--serial` uses **demo/stub** observations so export formats can be exercised without hardware. Real field capture today is the Android app talking to the ESP32-C5 over USB serial.
